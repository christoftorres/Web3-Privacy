...
const walletSimulatorWithAntiBotDetection = require('./helpers/walletSimulatorWithAntiBotDetection');
const walletSimulator = require('./helpers/walletSimulator');
...
async function crawlAndSaveData(urlString, dataCollectors, log, filterOutFirstParty, dataCallback, emulateMobile, proxyHost, antiBotDetection, executablePath, maxLoadTimeMs, extraExecutionTimeMs, collectorFlags) {
    ...
    const data = await crawl(url, {
        ...
        emulateMobile,
        proxyHost,
        runInEveryFrame: antiBotDetection ? walletSimulatorWithAntiBotDetection : walletSimulator,
        executablePath,
        maxLoadTimeMs,
